	...
	if (!empty(JAK_DSGVO_CONTACT)) {
		...
		if (count($errors) > 0) {
			...
			if (JAK_SMTP_MAIL) {
				...
				$mail->AddReplyTo($jkp['gemail'], $jkp['gname']);
...
if (JAK_USERID && jak_get_access("answers", $jakuser->getVar("permissions"), JAK_SUPERADMINACCESS) && empty($cms_text)) {
	...
	$jakdb->insert("translations", [["lang" => $BT_LANGUAGE, "cmsid" => 1, "title" => "<h3>Smart FAQ Search</h3>", "description" => "<p class=\"txt-small\">Search through our FAQ with the build in smart search.</p>", "time" => $jakdb->raw("NOW()")],
	["lang" => $BT_LANGUAGE, "cmsid" => 2, "title" => "<h4><strong>Cloud</strong><small>Desk 3</small></h4>", "description" => "<p class=\"txt-small\">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum.</p>\r\n<p class=\"mb-0\">Phone: <strong>+41 (0) 77 482 57 15</strong></p>\r\n<p>Email: <strong>youremail@domain.com</strong></p>", "time" => $jakdb->raw("NOW()")],
	["lang" => $BT_LANGUAGE, "cmsid" => 3, "title" => "<h4 class=\"title-green\">Features</h4>", "description" => "", "time" => $jakdb->raw("NOW()")],
	["lang" => $BT_LANGUAGE, "cmsid" => 4, "title" => "<h4 class=\"title-green\">About Us</h4>", "description" => "", "time" => $jakdb->raw("NOW()")],
	["lang" => $BT_LANGUAGE, "cmsid" => 5, "title" => "<h3 class=\"title-green\">Latest News</h3>", "description" => "<p>Our blog will inform you about the latest news about our company.</p>", "time" => $jakdb->raw("NOW()")],
	["lang" => $BT_LANGUAGE, "cmsid" => 6, "title" => "<h4>Contact Form</h4>", "description" => "<p>Please fill at least the name, email and message field.</p>", "time" => $jakdb->raw("NOW()")],
	["lang" => $BT_LANGUAGE, "cmsid" => 7, "title" => "<h3 class=\"title-green\">Latest FAQ Articles</h3>", "description" => "<p>The latest FAQ article, browse through our frequently asked question database and get smart.</p>", "time" => $jakdb->raw("NOW()")],
	["lang" => $BT_LANGUAGE, "cmsid" => 8, "title" => "<h3 class=\"title-green\">Our FAQ Article</h3>", "description" => "<p>Check all our frequently asked questions and get smart.</p>", "time" => $jakdb->raw("NOW()")],
	["lang" => $BT_LANGUAGE, "cmsid" => 9, "title" => "<h3 class=\"title-green\">Latest Support Tickets</h3>", "description" => "<p>Our latest support tickets, grab some knowledge from our database.</p>", "time" => $jakdb->raw("NOW()")],
	["lang" => $BT_LANGUAGE, "cmsid" => 10, "title" => "<h3 class=\"title-green\">Support Tickets</h3>", "description" => "<p>Grab some knowledge from our public support tickets.</p>", "time" => $jakdb->raw("NOW()")],
	["lang" => $BT_LANGUAGE, "cmsid" => 11, "title" => "<h3>All Blog Articles</h3>", "description" => "<p>Check our latest articles now and in full length.</p>", "time" => $jakdb->raw("NOW()")],
	["lang" => $BT_LANGUAGE, "cmsid" => 12, "title" => "<h3>Client Dashboard</h3>", "description" => "<p>Welcome to your dashboard, you will find all your tickets, payments and profile information on this page.</p>", "time" => $jakdb->raw("NOW()")],
	["lang" => $BT_LANGUAGE, "cmsid" => 13, "title" => "<h3>Billing History</h3>", "description" => "<p>Your billing history on our site</p>", "time" => $jakdb->raw("NOW()")],
	["lang" => $BT_LANGUAGE, "cmsid" => 14, "title" => "<h3>Subscriptions</h3>", "description" => "<p>Select the package that suits you.</p>", "time" => $jakdb->raw("NOW()")],
	["lang" => $BT_LANGUAGE, "cmsid" => 15, "title" => "<h3>Edit Profile</h3>", "description" => "<p>Edit your profile add your personal avatar and get some nuts.</p>", "time" => $jakdb->raw("NOW()")],
	["lang" => $BT_LANGUAGE, "cmsid" => 16, "title" => "<h3>How would you rate the support you received?</h3>", "description" => "<p>Hello %client%,<br>We\'d love to hear what you think of our customer service. Please take a moment to rate the support you have received by clicking the link below.<br>How would you rate the support you received?</p>", "time" => $jakdb->raw("NOW()")],
	["lang" => $BT_LANGUAGE, "cmsid" => 17, "title" => "<h4>Mobile Apps</h4>", "description" => '<ul class="social-buttons"><li><a href="https://play.google.com/store/apps/details?id=ch.jakweb.livechat" class="btn btn-just-icon btn-link btn-android"><i class="material-icons">phone_android</i></a></li><li><a href="https://itunes.apple.com/us/app/live-chat-3-lcps/id1229573974" class="btn btn-just-icon btn-link btn-apple"><i class="material-icons">phone_iphone</i></a></li></ul><h5>Numbers Don&apos;t Lie</h5><h4>14.521<small> Freelancers</small></h4><h4>1.423.183<small> Transactions</small></h4>', "time" => $jakdb->raw("NOW()")],
	["lang" => $BT_LANGUAGE, "cmsid" => 18, "title" => "", "description" => "", "time" => $jakdb->raw("NOW()")],
    ["lang" => $BT_LANGUAGE, "cmsid" => 19, "title" => "", "description" => "", "time" => $jakdb->raw("NOW()")],
	["lang" => $BT_LANGUAGE, "cmsid" => 20, "title" => "", "description" => "", "time" => $jakdb->raw("NOW()")],
	["lang" => $BT_LANGUAGE, "cmsid" => 21, "title" => "", "description" => "", "time" => $jakdb->raw("NOW()")]]);
	
	// Redirect back to the place to be
	jak_redirect(BASE_URL);
}

// Make sure the page is available for everyone.
if ($row["access"] == 3 && !JAK_USERISLOGGED) {
	include_once APP_PATH.'template/modern/client.php';
} else {
	// Get the correct page
	if ($row["prepage"] == JAK_CLIENT_URL) {
		include_once APP_PATH.'template/modern/client.php';
	} elseif ($row["prepage"] == JAK_SEARCH_URL) {
		include_once APP_PATH.'template/modern/search.php';
	} elseif ($row["prepage"] == JAK_SUPPORT_URL) {
		include_once APP_PATH.'template/modern/support.php';
	} elseif ($row["prepage"] == JAK_FAQ_URL) {
		include_once APP_PATH.'template/modern/faq.php';
	} elseif ($row["prepage"] == JAK_BLOG_URL) {
		include_once APP_PATH.'template/modern/blog.php';
	} else {
		include_once APP_PATH.'template/modern/tplblocks/page.php';
	}
}
?>