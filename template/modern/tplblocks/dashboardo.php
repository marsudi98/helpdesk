      ...
      <div class="col-md-3">
        ...
        <div class="card card-profile">
          <div class="card-header card-header-image">
            <a href="<?php echo JAK_rewrite::jakParseurl('operator', 'users', 'edit', JAK_USERID);?>">
              <img class="img" src="<?php echo BASE_URL.JAK_FILES_DIRECTORY.$jakuser->getVar("picture");?>" alt="profile-picture">
            </a>
          </div>
          <div class="card-body">
            <h4 class="card-title"><?php echo $jakuser->getVar("name");?></h4>
            <h6 class="card-category text-gray"><?php echo $jakuser->getVar("email");?></h6>
