...
(function() {
  ...
  ContentTools = {
    ...
    DEFAULT_TOOLS: [['bold', 'italic', 'link', 'align-left', 'align-center', 'align-right'], ['heading', 'subheading', 'subheadingh4', 'paragraph', 'unordered-list', 'ordered-list', 'table', 'indent', 'unindent'], ['video', 'preformatted', 'line-break'], ['undo', 'redo', 'remove']],
  ...
  ContentTools.Tools.Subheadingh4 = (function(_super) {
    __extends(Subheadingh4, _super);

    function Subheadingh4() {
      return Subheadingh4.__super__.constructor.apply(this, arguments);
    }

    ContentTools.ToolShelf.stow(Subheadingh4, 'subheadingh4');

    Subheadingh4.label = 'Subheadingh4';

    Subheadingh4.icon = 'subheading';

    Subheadingh4.tagName = 'h4';
