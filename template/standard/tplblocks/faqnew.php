...
?>
<div class="col-md-4">
  <div class="card custom-card-<?php echo $faqn["class"];?>">
    ...
    <div class="card-footer">
      <a href="<?php echo $faqparseurl;?>"><?php echo $jkl["hd1"];?><span class="pull-right"><i class="fa fa-arrow-circle-o-right fa-2x"></i></span></a>
    </div>
  </div>
</div>
<?php } ?>
