...
Dropzone.autoDiscover = false;
  $(function() {
    ...
    myDropzone.on("success", function(file, serverResponse) {
        ...
        if (data.isimage) {
          thefile = '<tr><td><a data-toggle="lightbox" href="<?php echo BASE_URL;?>'+data.filepath+'"><img src="<?php echo BASE_URL;?>'+data.filepath+'" alt="'+data.filename+'" class="img-thumbnail" width="50"></a> <a href="<?php echo BASE_URL;?>'+data.filepath+'" class="btn btn-info btn-sm"><i class="fa fa-floppy-o"></i></a></td></tr>';
        } else {
          thefile = '<tr><td>'+data.filename+' <a href="<?php echo BASE_URL;?>'+data.filepath+'" class="btn btn-info btn-sm"><i class="fa fa-floppy-o"></i></a></td></tr>';
        }
