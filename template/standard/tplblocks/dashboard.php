...
<?php if (isset($allcsupport) && is_array($allcsupport)) { ?>
  ...
  <div class="content-dashboard-block">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12">
          <p><a href="<?php echo JAK_rewrite::jakParseurl(JAK_SUPPORT_URL, 'n');?>" class="text-danger"><i class="fa fa-ticket-alt"></i> <?php echo $jkl['hd47'];?></a></p>
        </div>
      </div>
      <div class="row">
        <div class="col-md-9">
          <table id="sortable-data" class="table table-responsive table-light w-100 d-block d-md-table">
      ...
      <div class="col-md-3">
        <div class="card">
          <img class="card-img-top card-profile" src="<?php echo BASE_URL.JAK_FILES_DIRECTORY.$jakclient->getVar("picture");?>" alt="profile-picture">
          <div class="card-body">
            <h4 class="card-title"><?php echo $jakclient->getVar("name");?> <span class="pull-right"><a href="<?php echo JAK_rewrite::jakParseurl(JAK_CLIENT_URL, 'edit');?>"><i class="fa fa-pencil-square-o"></i></a></span></h4>
            <?php if (JAK_BILLING_MODE == 1) { ?>
              <p class="card-text"><strong><?php echo $jkl['hd46'];?></strong><br><?php echo sprintf($jkl['hd44'], $jakclient->getVar("credits"));?></p>
            <?php } elseif (JAK_BILLING_MODE == 2) { ?>
              <p class="card-text"><strong><?php echo $jkl['hd46'];?></strong><br><?php echo sprintf($jkl['hd45'], JAK_base::jakTimesince($jakclient->getVar("paid_until"), JAK_DATEFORMAT, JAK_TIMEFORMAT));?></p>
            <?php } ?>
            ...
            <p class="card-text"><a href="<?php echo JAK_rewrite::jakParseurl('logout');?>" class="btn btn-sm btn-block btn-danger"><i class="fa fa-sign-out"></i> <?php echo $jkl['g26'];?></a></p>
          </div>
        </div>
      </div>
    </div>
