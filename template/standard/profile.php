    ...
    if (count($errors) > 0) {
    	...
    	if (JAK_CLIENTID) {
    		...
    		if ($jakclient->getVar("faq_cat") == 0) {
    			$searchresult = $jakdb->select($jaktable2, ["[>]".$jaktable3 => ["catid" => "id"]], ["faq_article.id", "faq_article.lang", "faq_article.title", "faq_article.content", "faq_categories.class", "faq_categories.title(titlecat)"], ["faq_article.active" => 1,
				"MATCH" => [
			...
			// Only for certain categories
    			...
    			$searchresult = $jakdb->select($jaktable2, ["[>]".$jaktable3 => ["catid" => "id"]], ["faq_article.id", "faq_article.lang", "faq_article.title", "faq_article.content", "faq_categories.class", "faq_categories.title(titlecat)"], ["AND" => ["faq_article.catid" => [$jakclient->getVar("faq_cat")], "faq_article.active" => 1],
				"MATCH" => [
					"columns" => ["faq_article.content", "faq_article.title"],
					"keyword" => $SearchInput],
				"LIMIT" => 10
		...
		// Can see categories for guests
    		...
    		$searchresult = $jakdb->select($jaktable2, ["[>]".$jaktable3 => ["catid" => "id"]], ["faq_article.id", "faq_article.lang", "faq_article.title", "faq_article.content", "faq_categories.class", "faq_categories.title(titlecat)"], ["AND" => ["faq_categories.guesta" => 1, "faq_article.active" => 1],
			"MATCH" => [
				"columns" => ["faq_article.content", "faq_article.title"],
				"keyword" => $SearchInput],
				"LIMIT" => 10
