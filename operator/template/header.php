          ...
          <div class="collapse navbar-collapse justify-content-end" id="navigation">
            ...
            <ul class="navbar-nav">
              <li class="nav-item dropdown" id="chatRequests" style="display: none">
                <a class="nav-link dropdown-toggle" id="navbarDropdownLiveChat" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="<?php echo $jkl['hd140'];?>">
              ...
              <li class="nav-item dropdown" id="ticketRequests" style="display: none">
                <a class="nav-link dropdown-toggle" id="navbarDropdownTicketRequest" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="<?php echo $jkl['hd141'];?>">
                  <i class="fa fa-ticket-alt"></i>
                  <span class="notification" id="totaltickets" style="display:none"></span>
                </a>
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownTicketRequest" id="currentTickets">
                </div>
              </li>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="<?php echo $jkl['hd167'];?>">
