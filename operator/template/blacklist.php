  ...
  <div class="col-md-3">
    <div class="card card-stats">
          ...
          <div class="info info-horizontal">
            <div class="row">
              ...
              <div class="col-9 text-right">
                <h3 class="info-title"><?php echo count($BLACKLIST_ALL);?></h3>
                <h6 class="stats-title"><?php echo $jkl["stat_s67"];?></h6>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="card-footer">
        <div class="stats">
          <i class="fa fa-spider-black-widow"></i> <?php echo $jkl["stat_s67"];?>
        </div>
      </div>
    </div>
  </div><!-- ./col -->
