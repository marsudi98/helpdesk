...
<div class="row">
	<div class="col-md-6">
		...
		<div class="card">
			...
			<div class="form-group">
				<label for="aboutme"><?php echo $jkl["hd250"];?></label>
            ...
            <h4 class="card-title"><?php echo $jkl["hd9"];?></h4>
		...
		<?php } ?>
            ...
            <div class="form-group">
                <p><label><?php echo $jkl["u58"];?></label></p>
                <select name="jak_themecolour" class="selectpicker" title="<?php echo $jkl["u58"];?>" data-size="4" data-live-search="true">
                    <option value="blue"<?php if ($JAK_FORM_DATA["themecolour"] == 'blue') echo ' selected';?>><?php echo $jkl["hd267"];?></option>
                    <option value="green"<?php if ($JAK_FORM_DATA["themecolour"] == 'green') echo ' selected';?>><?php echo $jkl["hd268"];?></option>
                    <option value="orange"<?php if ($JAK_FORM_DATA["themecolour"] == 'orange') echo ' selected';?>><?php echo $jkl["hd269"];?></option>
                    <option value="red"<?php if ($JAK_FORM_DATA["themecolour"] == 'red') echo ' selected';?>><?php echo $jkl["hd270"];?></option>
                    <option value="yellow"<?php if ($JAK_FORM_DATA["themecolour"] == 'yellow') echo ' selected';?>><?php echo $jkl["hd271"];?></option>
                </select>
            </div>
	...
	<div class="col-md-6">
		...
		<div class="card-body">
			...
			<div class="form-check form-check-inline">
  				<label class="form-check-label">
    			<input class="form-check-input" type="checkbox" name="jak_roles[]" value="support"<?php if (in_array("support", explode(',', $JAK_FORM_DATA["permissions"]))) { ?> checked="checked"<?php } ?>>
    			<span class="form-check-sign"></span> <?php echo $jkl["hd"];?>
    			</label>
    		</div>

			<div class="form-check form-check-inline">
  				<label class="form-check-label">
    			<input class="form-check-input" type="checkbox" name="jak_roles[]" value="faq"<?php if (in_array("faq", explode(',', $JAK_FORM_DATA["permissions"]))) { ?> checked="checked"<?php } ?>>
    			<span class="form-check-sign"></span> <?php echo $jkl["hd1"];?>
    			</label>
    		</div>

			<div class="form-check form-check-inline">
  				<label class="form-check-label">
    			<input class="form-check-input" type="checkbox" name="jak_roles[]" value="blog"<?php if (in_array("blog", explode(',', $JAK_FORM_DATA["permissions"]))) { ?> checked="checked"<?php } ?>>
    			<span class="form-check-sign"></span> <?php echo $jkl["hd13"];?>
    			</label>
    		</div>
    		...
    		<div class="form-check form-check-inline">
  				<label class="form-check-label">
    			<input class="form-check-input" type="checkbox" name="jak_roles[]" value="client"<?php if (in_array("client", explode(',', $JAK_FORM_DATA["permissions"]))) { ?> checked="checked"<?php } ?>>
    			<span class="form-check-sign"></span> <?php echo $jkl["hd14"];?>
    			</label>
    		</div>

    		<div class="form-check form-check-inline">
  				<label class="form-check-label">
    			<input class="form-check-input" type="checkbox" name="jak_roles[]" value="billing"<?php if (in_array("billing", explode(',', $JAK_FORM_DATA["permissions"]))) { ?> checked="checked"<?php } ?>>
    			<span class="form-check-sign"></span> <?php echo $jkl["hd22"];?>
    			</label>
    		</div>
