...
<div class="row">
  ...
  <div class="col-md-3">
    <div class="card card-stats">
      ...
      <div class="card-footer">
        <div class="stats">
          <i class="fa fa-book-user"></i> <?php echo $jkl["hd23"];?>
        </div>
      </div>
    </div>
  </div><!-- ./col -->
  ...
  <div class="row">
    ...
    <div class="card">
    	<div class="card-header">
    		<h3 class="card-title"><i class="fa fa-cogs"></i> <?php echo $jkl["hd107"];?></h3>
    	</div><!-- /.box-header -->
    	<div class="card-body">

    		<label><?php echo $jkl["hd108"];?></label>
    		<div class="form-check form-check-radio">
               	<label class="form-check-label">
                   	<input class="form-check-input" type="radio" name="jak_blog" value="1"<?php if (JAK_BLOG_A == 1) echo ' checked="checked"';?>>
            ...
            <div class="form-check form-check-radio">
                <label class="form-check-label">
                    <input class="form-check-input" type="radio" name="jak_blog" value="0"<?php if (JAK_BLOG_A == 0) echo ' checked="checked"';?>>
                    <span class="form-check-sign"></span>
                    <?php echo $jkl["g18"];?>
                </label>
            </div>

            <label><?php echo $jkl["hd218"];?></label>
    		<div class="form-check form-check-radio">
               	<label class="form-check-label">
                   	<input class="form-check-input" type="radio" name="jak_blogc" value="1"<?php if (JAK_BLOGPOSTAPPROVE == 1) echo ' checked="checked"';?>>
                    <span class="form-check-sign"></span>
                    <?php echo $jkl["g19"];?>
                </label>
            </div>
            <div class="form-check form-check-radio">
                <label class="form-check-label">
                    <input class="form-check-input" type="radio" name="jak_blogc" value="0"<?php if (JAK_BLOGPOSTAPPROVE == 0) echo ' checked="checked"';?>>
                    <span class="form-check-sign"></span>
                    <?php echo $jkl["g18"];?>
                </label>
            </div>
            ...
            <div class="form-group">
        		...
        		<select name="jak_blog_home" class="selectpicker" title="<?php echo $jkl["hd109"];?>" data-size="4">
    		...
    		<div class="form-group">
        		...
        		<select name="jak_blog_footer" class="selectpicker" title="<?php echo $jkl["hd110"];?>" data-size="4">
  ...
  <div class="col-md-6">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="form-group">
          <p><label class="control-label" for="jak_blog_page"><?php echo $jkl["hd272"];?></label></p>
          <select name="jak_blog_page" class="selectpicker" data-style="select-with-transition">
          <?php for ($i = 1; $i < 20; $i++) {
            if ($i == JAK_BLOG_PAGE) {
            echo '<option value="'.$i.'" selected>'.$i.'</option>';
            } else {
        ...
        <div class="form-group">
          <p><label class="control-label" for="jak_blog_pagination"><?php echo $jkl["hd273"];?></label></p>
          <select name="jak_blog_pagination" class="selectpicker" data-style="select-with-transition">
          <?php for ($i = 5; $i < 20; $i++) {
