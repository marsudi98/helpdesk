			...
			<div class="card">
				<div class="card-body">
					...
					<ul class="nav nav-pills nav-pills-primary nav-pills-icons justify-content-center">
                      <li class="nav-item">
                      	<a href="javascript:void(0)" data-chat="info" title="<?php echo $jkl['g40'];?>" class="nav-link lc-info"><i class="fa fa-user"></i><?php echo $jkl['g136'];?></a>
                      </li>
                      <li class="nav-item">
                      ...
                      <li class="nav-item">
                        <a href="javascript:void(0)" data-chat="faq" title="<?php echo $jkl['hd1'];?>" class="nav-link lc-info"><i class="fa fa-lightbulb"></i><?php echo $jkl['hd1'];?></a>
                      </li>
                      <li class="nav-item">
                        <a href="javascript:void(0)" data-chat="history" title="<?php echo $jkl['hd266'];?>" class="nav-link lc-info"><i class="fa fa-history"></i><?php echo $jkl['hd266'];?></a>
                      </li>
                    </ul>
