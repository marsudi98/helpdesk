...
<div class="row">
	...
	<div class="col-md-8">
		...
		<p><textarea class="form-control" id="widget-code" readonly="readonly" rows="11"><?php echo htmlentities('<!-- HelpDesk 3 group chat widget -->
...
<!-- end HelpDesk 3 group chat widget -->');?></textarea></p>
