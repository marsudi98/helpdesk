	...
	<div class="col-md-6">
			...
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="form-check form-check-inline">
	  					<label class="form-check-label">
	    					<input class="form-check-input" type="checkbox" name="jak_roles[]" value="support"<?php if (isset($_REQUEST["jak_roles"]) && in_array("support", $_REQUEST["jak_roles"])) { ?> checked="checked"<?php } ?>>
					...
					<div class="form-check form-check-inline">
	  					<label class="form-check-label">
	    					<input class="form-check-input" type="checkbox" name="jak_roles[]" value="faq"<?php if (isset($_REQUEST["jak_roles"]) && in_array("faq", $_REQUEST["jak_roles"])) { ?> checked="checked"<?php } ?>>
					...
					<div class="form-check form-check-inline">
	  					<label class="form-check-label">
	    					<input class="form-check-input" type="checkbox" name="jak_roles[]" value="blog"<?php if (isset($_REQUEST["jak_roles"]) && in_array("blog", $_REQUEST["jak_roles"])) { ?> checked="checked"<?php } ?>>
	    			...
	    			<div class="form-check form-check-inline">
	  					<label class="form-check-label">
	    					<input class="form-check-input" type="checkbox" name="jak_roles[]" value="client"<?php if (isset($_REQUEST["jak_roles"]) && in_array("client", $_REQUEST["jak_roles"])) { ?> checked="checked"<?php } ?>>
	    			...
	    			<div class="form-check form-check-inline">
	  					<label class="form-check-label">
	    					<input class="form-check-input" type="checkbox" name="jak_roles[]" value="billing"<?php if (isset($_REQUEST["jak_roles"]) && in_array("billing", $_REQUEST["jak_roles"])) { ?> checked="checked"<?php } ?>>
