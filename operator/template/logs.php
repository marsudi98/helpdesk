...
<div class="row">
  <div class="col-md-2">
    <div class="card card-stats">
          ...
          <div class="info info-horizontal">
            <div class="row">
              ...
              <div class="col-9 text-right">
                ...
                <h6 class="stats-title"><?php echo $jkl["stat_s35"];?></h6>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="card-footer">
        <div class="stats">
          <i class="fa fa-clipboard-list"></i> <?php echo $jkl["stat_s35"];?>
        </div>
      </div>
    </div>
  </div><!-- ./col -->
  <div class="col-md-5">
    <div class="card card-stats">
          ...
          <div class="info info-horizontal">
            <div class="row">
              ...
              <div class="col-9 text-right">
                ...
                <h6 class="stats-title"><?php echo $jkl["stat_s36"];?></h6>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="card-footer">
        <div class="stats">
          <i class="fa fa-user-md-chat"></i> <?php echo $jkl["stat_s36"];?>
        </div>
      </div>
    </div>
  </div><!-- ./col -->
  <div class="col-md-5">
    <div class="card card-stats">
        ...
        <div class="statistics statistics-horizontal">
          <div class="info info-horizontal">
            <div class="row">
              ...
              <div class="col-9 text-right">
                <h3 class="info-title"><?php echo $busy_client["email"];?></h3>
      ...
      <div class="card-footer">
        <div class="stats">
          <i class="fa fa-user"></i> <?php echo $jkl["stat_s37"];?>
        </div>
      </div>
    </div>
  </div><!-- ./col -->
