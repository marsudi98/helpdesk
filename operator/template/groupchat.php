		...
		<div class="card-header">
	  	...
	  	<div class="card-body">
				...
				<form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
					...
					<div class="form-group">
						<p><label for="operator"><?php echo $jkl["g20"];?> <a href="javascript:void(0)" class="jakweb-help" data-content="<?php echo $jkl["h6"];?>" data-original-title="<?php echo $jkl["t"];?>"><i class="fa fa-question-circle"></i></a></label></p>
...
<div class="col-md-8">
	<div class="card box-primary">
		<div class="card-header">
			<h3 class="card-title"><i class="fa fa-users-class"></i> <?php echo $jkl["hd262"];?></h3>
	  	</div><!-- /.box-header -->
	  	<div class="card-body">
