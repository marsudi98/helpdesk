<div class="modal-header">
    ...
    <div class="modal-body">
    	...
    	<ul class="nav nav-pills nav-pills-primary nav-pills-icons justify-content-center" role="tablist">
            <li class="nav-item">
                <a href="#support" data-toggle="tab" role="tablist" title="<?php echo $jkl['g40'];?>" class="nav-link active"><i class="fa fa-ticket-alt"></i><?php echo $jkl['hd175'];?></a>
            </li>
            <li class="nav-item">
                <a href="#chat" data-toggle="tab" role="tablist" title="<?php echo $jkl['g47'];?>" class="nav-link"><i class="fa fa-comments"></i><?php echo $jkl['hd174'];?></a>
            </li>
        </ul>
        	...
        	<div class="tab-pane active" id="support">
        		...
        		<div class="card">
		    		<div class="card-header">
		    			<h5 class="card-title"><i class="fa fa-ticket-alt"></i> <?php echo sprintf($jkl['hd303'], $USER_NAME);?></h5>
		    	  	</div><!-- /.box-header -->
		    	  	<div class="card-body">

		    	  		<strong><?php echo $jkl['stat_s68'];?></strong>
		    	  		<p><?php echo (!empty($USER_SUPPORT_TICKET_N) ? secondsToTime(round($USER_SUPPORT_TIME_N / $USER_SUPPORT_TICKET_N), $jkl['g230']) : '-');?></p>

		    	  		<strong><?php echo $jkl['stat_s69'];?></strong>
		    	  		<p><?php echo (!empty($USER_SUPPORT_TICKET) ? secondsToTime(round($USER_SUPPORT_TIME / $USER_SUPPORT_TICKET), $jkl['g230']) : '-');?></p>

		    	  		<strong><?php echo $jkl['stat_s70'];?></strong>
		    	  		<p><?php echo (!empty($USER_SUPPORT_TICKETS) ? secondsToTime(round(($USER_TICKETS_ENDED - $USER_TICKETS_INI) / $USER_SUPPORT_TICKETS), $jkl['g230']) : '-');?></p>
		    	...
		    	<div class="card">
		    		<div class="card-header">
		    	  	...
		    	  	<div class="card-body">
						...
						<ul class="list-group">
						<?php foreach($USER_FEEDBACK as $v) {
