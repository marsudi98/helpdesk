  ...
  <div class="col-md-3">
    <div class="card card-stats">
          ...
          <div class="info info-horizontal">
            <div class="row">
              ...
              <div class="col-9 text-right">
                <h3 class="info-title"><?php echo count($PRIORITY_ALL);?></h3>
                <h6 class="stats-title"><?php echo $jkl["stat_s64"];?></h6>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="card-footer">
        <div class="stats">
          <i class="fa fa-ruler"></i> <?php echo $jkl["stat_s64"];?>
        </div>
      </div>
    </div>
  </div><!-- ./col -->
...
<ul class="nav nav-pills nav-pills-primary">
  <li class="nav-item">
    <a class="nav-link active" href="<?php echo JAK_rewrite::jakParseurl('customfield');?>"><?php echo $jkl["hd149"];?></a>
  </li>
  <li class="nav-item">
...
<div class="col-md-4">
	...
	<div class="card">
		<div class="card-header">
			<h3 class="card-title"><i class="fal fa-ruler"></i> <?php echo $jkl["hd151"];?></h3>
	  	</div><!-- /.box-header -->
	  	<div class="card-body">
...
<div class="col-md-8">
	<div class="card box-primary">
		<div class="card-header">
			<h3 class="card-title"><i class="fa fa-ruler"></i> <?php echo $jkl["hd265"];?></h3>
	  	</div><!-- /.box-header -->
	  	<div class="card-body">

	  		<?php if (isset($PRIORITY_ALL) && is_array($PRIORITY_ALL) && !empty($PRIORITY_ALL)) { ?>
			...
			<table class="table table-striped">
				...
				<tbody>
					<?php foreach($PRIORITY_ALL as $v) { ?>
					<tr>
					<td><?php echo $v["id"];?></td>
					<td class="title"><a href="<?php echo JAK_rewrite::jakParseurl('customfield', 'edit', $v["id"]);?>"><?php echo $v["title"];?></a></td>
					<td class="desc"><?php echo $v["class"];?></td>
					<td class="desc"><?php echo $v["dorder"];?></td>
					<td><a class="btn btn-default btn-sm" href="<?php echo JAK_rewrite::jakParseurl('customfield', 'edit', $v["id"]);?>"><i class="fa fa-pencil"></i></a></td>
					<td><a class="btn btn-danger btn-sm btn-confirm" href="<?php echo JAK_rewrite::jakParseurl('customfield', 'delete', $v["id"]);?>" data-title="<?php echo addslashes($jkl["g48"]);?>" data-text="<?php echo addslashes($jkl["e31"]);?>" data-type="warning" data-okbtn="<?php echo addslashes($jkl["g279"]);?>" data-cbtn="<?php echo addslashes($jkl["g280"]);?>"><i class="fa fa-trash-alt"></i></a></td>
					</tr>
					<?php } ?>
				</tbody>
			</table>
