...
<li<?php if ($page == 'support') echo ' class="active"';?>><a href="<?php echo JAK_rewrite::jakParseurl('support');?>"><i class="fas fa-ticket-alt"></i> <p><?php echo $jkl["hd"];?></p></a></li>
<?php } if (jak_get_access("leads", $jakuser->getVar("permissions"), JAK_SUPERADMINACCESS)){?>
<li<?php if (in_array($page, array('leads', 'live'))) echo ' class="active"';?>><a href="<?php echo JAK_rewrite::jakParseurl('leads');?>"><i class="fas fa-comments-alt"></i> <p><?php echo $jkl["m1"];?></p></a></li>
...
<?php } ?>
<li<?php if (in_array($page, array('blog', 'faq', 'answers', 'billing', 'groupchat', 'widget'))) echo ' class="active"';?>>
<a data-toggle="collapse" href="#navcms">
            ...
            <div class="collapse<?php if (in_array($page, array('blog', 'faq', 'answers', 'billing', 'groupchat', 'widget'))) echo ' show';?>" id="navcms">
            <ul class="nav">
<?php if (jak_get_access("faq", $jakuser->getVar("permissions"), JAK_SUPERADMINACCESS)){?>
<li<?php if ($page == 'faq') echo ' class="active"';?>><a href="<?php echo JAK_rewrite::jakParseurl('faq');?>">
	<span class="sidebar-mini-icon"><?php echo $jkl["hd1"][0];?></span>
    <span class="sidebar-normal"> <?php echo $jkl["hd1"];?></span>
</a></li>
<?php } if (jak_get_access("blog", $jakuser->getVar("permissions"), JAK_SUPERADMINACCESS)){?>
<li<?php if ($page == 'blog') echo ' class="active"';?>><a href="<?php echo JAK_rewrite::jakParseurl('blog');?>">
	<span class="sidebar-mini-icon"><?php echo $jkl["hd13"][0];?></span>
    <span class="sidebar-normal"> <?php echo $jkl["hd13"];?></span>
</a></li>
...
<li<?php if ($page1 == 'cms') echo ' class="active"';?>><a href="<?php echo JAK_rewrite::jakParseurl('answers', 'cms');?>">
	<span class="sidebar-mini-icon"><?php echo $jkl["hd126"][0];?></span>
    <span class="sidebar-normal"> <?php echo $jkl["hd126"];?></span>
</a></li>
<?php } if (jak_get_access("billing", $jakuser->getVar("permissions"), JAK_SUPERADMINACCESS)){?>
<li<?php if ($page == 'billing') echo ' class="active"';?>><a href="<?php echo JAK_rewrite::jakParseurl('billing');?>">
	<span class="sidebar-mini-icon"><?php echo $jkl["hd22"][0];?></span>
    <span class="sidebar-normal"> <?php echo $jkl["hd22"];?></span>
</a></li>
...
<li<?php if (in_array($page, array('departments', 'response', 'bot', 'proactive', 'files', 'customfield', 'buttons', 'blacklist'))) echo ' class="active"';?>>
<a data-toggle="collapse" href="#navgeneralsettings">
            ...
            <div class="collapse<?php if (in_array($page, array('departments', 'response', 'bot', 'proactive', 'files', 'customfield', 'buttons', 'blacklist'))) echo ' show';?>" id="navgeneralsettings">
            <ul class="nav">
...
<li<?php if ($page == 'customfield') echo ' class="active"';?>><a href="<?php echo JAK_rewrite::jakParseurl('customfield');?>">
	<span class="sidebar-mini-icon"><?php echo $jkl["hd148"][0];?></span>
    <span class="sidebar-normal"> <?php echo $jkl["hd148"];?></span>
</a></li>
...
<span class="sidebar-normal"> <?php echo $jkl["g122"];?></span>
</a></li>
...
<li<?php if ($page == 'users') echo ' class="active"';?>><a href="<?php echo JAK_rewrite::jakParseurl('users');?>"><i class="fas fa-users-cog"></i> <p><?php echo $jkl["m4"];?></p></a></li>
...
<li<?php if ($page == 'maintenance') echo ' class="active"';?>><a href="<?php echo JAK_rewrite::jakParseurl('maintenance');?>"><i class="fas fa-tools"></i> <p><?php echo $jkl["m19"];?></p></a></li>
<?php } if ($jakhs['hostactive'] == 1 && !empty(JAKDB_MAIN_NAME)) { ?>
<li<?php if ($page == 'tickets') echo ' class="active"';?>><a href="<?php echo JAK_rewrite::jakParseurl('tickets');?>"><i class="fas fa-user-headset"></i> <p><<?php echo $jkl["m31"];?></p></a></li>
<?php } ?>
</ul>