...
<div class="row">
  <div class="col-md-3">
    <div class="card card-stats">
      ...
      <div class="card-footer">
        <div class="stats">
          <i class="fa fa-users"></i> <?php echo $jkl["stat_s39"];?>
        </div>
      </div>
    </div>
  </div><!-- ./col -->
  ...
  <div class="col-md-3">
    <div class="card card-stats">
      ...
      <div class="card-footer">
        <div class="stats">
          <i class="fa fa-sign-in"></i> <?php echo $jkl["stat_s40"];?>
        </div>
      </div>
    </div>
  </div><!-- ./col -->
...
<ul class="nav nav-pills nav-pills-primary">
  ...
  <li class="nav-item">
    <a class="nav-link active" href="<?php echo JAK_rewrite::jakParseurl('users', 'droppoints');?>"><?php echo 'Droppoints';?></a>
  </li>
  <?php } ?>
</ul>
</p>
...
<td><a class="btn btn-default btn-sm" data-toggle="modal" href="<?php echo JAK_rewrite::jakParseurl('users', 'stats', $v["id"], $v["username"]);?>" data-target="#jakModal"><i class="fa fa-signal"></i></a></td>
