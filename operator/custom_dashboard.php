...
switch ($page1) {
	case 'operator':
		...
		// echo "<pre>";
		$query = $jakdb->query("
		SELECT st.operatorid, st.priorityid, tp.title, us.name, COUNT(st.id) as jumlah,
			CASE
		...
		if ($query != null && !empty($query)) {
			...
			foreach ($query as $data) {
				...
				if (!array_key_exists($data["name"], $result["operator_complain"])) {
					array_push($operator_list, $data["name"]);
					$result["operator_complain"][$data["name"]] 					= [];
					$result["operator_complain"][$data["name"]]["clear"] 			= [];
					$result["operator_complain"][$data["name"]]["late"] 			= [];
					$result["operator_complain"][$data["name"]]["unclear"] 			= [];
					$result["operator_complain"][$data["name"]]["all"] 				= 0;
					$result["operator_complain"][$data["name"]]["clear"]["all"] 	= 0;
					$result["operator_complain"][$data["name"]]["late"]["all"] 		= 0;
					$result["operator_complain"][$data["name"]]["unclear"]["all"] 	= 0;
					$result["today"][$data["name"]]["pc"] 							= 0;
					$result["today"][$data["name"]]["np"] 							= 0;

					foreach ($cat_list_query as $title) {
						$title["title"] = ($title["title"] == null || $title["title"] == "") ? "???" : $title["title"];
						$result["operator_complain"][$data["name"]]["clear"][$title["title"]] 	= 0;
						$result["operator_complain"][$data["name"]]["late"][$title["title"]] 	= 0;
						$result["operator_complain"][$data["name"]]["unclear"][$title["title"]] = 0;
						$result["today"][$data["name"]][$title["title"]] 						= 0;
					}
				}
				...
				if ($data["prior"] == 11) {			//case cleared - old
					...
					$result["operator_complain"][$data["name"]]["clear"]["all"] 				+= $data["jumlah"];
					$result["operator_complain"][$data["name"]]["clear"][$data["title"]] 		+= $data["jumlah"];
					...
					$result["today"][$data["name"]]["pc"] 										+= $data["jumlah"];
					$result["today"][$data["name"]][$title["title"]] 							+= $data["jumlah"];
					...
					$result["operator_complain"][$data["name"]]["late"]["all"] 					+= $data["jumlah"];
					$result["operator_complain"][$data["name"]]["late"][$data["title"]] 		+= $data["jumlah"];
					...
					$result["operator_complain"][$data["name"]]["unclear"]["all"] 				+= $data["jumlah"];
					$result["operator_complain"][$data["name"]]["unclear"][$data["title"]] 		+= $data["jumlah"];
					$result["today"]["global_complain"]["np"] 									+= $data["jumlah"];
					$result["today"][$data["name"]]["np"] 										+= $data["jumlah"];
				...
				$result["operator_complain"][$data["name"]]["all"] += $data["jumlah"];
			}
