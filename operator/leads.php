  	...
  	case 'readleads':
  		...
  		if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['email_conv'])) {
              ...
              $mail->SMTPAutoTLS = false;
  		    		...
  		    		$mail->SetFrom(JAK_EMAIL, $jkl["g55"]);
  		    		$mail->AddAddress($jkp['email'], $jkp['email']);
          ...
          if (isset($jkp['jak_delete_leads'])) {
            ...
            $lockuser = $jkp['jak_delete_leads'];
              ...
              for ($i = 0; $i < count($lockuser); $i++) {
                  ...
                  JAK_base::jakWhatslog('', JAK_USERID, 0, 23, $locked, (isset($_COOKIE['WIOgeoData']) ? $_COOKIE['WIOgeoData'] : ''), $jakuser->getVar("username"), $_SERVER['REQUEST_URI'], $ipa, $valid_agent);
