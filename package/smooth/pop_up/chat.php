...
<div class="container">
	...
	<div class="row">
		<div class="col-sm-8">
			...
			<!--- Chat output -->
			<div id="jrc_chat_output" class="direct-chat-messages pop-up-chat"></div>
			...
			<!-- Client Input -->
				<form action="javascript:sendInput();" name="messageInput" id="MessageInput">
					...
					<button name="sendMSG" id="sendMessage" class="btn btn-primary btn-block"><i class="fa fa-paper-plane"></i> <?php echo $jkl["g11"];?></button>
		...
		<div class="col-sm-4 sidebar">
			...
			<p class="pb-0 mb-0"><span id="oname"></span></p>
			...
			<!-- Operator is typing -->
			<p><span class="badge badge-pill badge-success" id="jrc_typing"></span></p>
