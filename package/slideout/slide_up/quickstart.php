			...
			<div class="form-group slide-send-btn">
				...
				<div class="input-group">
					<div class="emoji-picker">
				  	...
				  	<input type="text" name="message" id="message" placeholder="<?php echo $jkl["g6"];?>" class="form-control chat_txt_msg">
				  	<span class="input-group-btn">
				    	<button type="submit" class="btn btn-success btn-flat"><i class="fa fa-paper-plane"></i></button>
				  	</span>
				</div>
			</div>
