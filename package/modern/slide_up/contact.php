		...
		<div class="jak-thankyou"></div>
			...
			<form class="jak-ajaxform" method="post" action="<?php echo $_SERVER['REQUEST_URI'];?>">
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" name="name" id="name" class="form-control modern" placeholder="<?php echo $jkl["g4"];?>">
						</div>
					</div>
					<div class="col-6">
						<div class="form-group">
						    <label class="sr-only" for="email"><?php echo $jkl["g5"];?></label>
							<input type="text" name="email" id="email" class="form-control modern" placeholder="<?php echo $jkl["g5"];?>">
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<input type="text" name="phone" id="phone" class="form-control modern" placeholder="<?php echo $jkl["g49"];?>">
				</div>
				<?php } ?>
				<div class="form-group">
				    <label class="sr-only" for="contactmsg"><?php echo $jkl["g6"];?></label>
				    <textarea name="message" id="contactmsg" rows="3" class="form-control modern" placeholder="<?php echo $jkl["g6"];?>"></textarea>
				</div>
				...
				<div class="text-center">
					<button type="submit" class="btn btn-sm btn-dark ls-submit"><?php echo $jkl["g7"];?></button>
				</div>
