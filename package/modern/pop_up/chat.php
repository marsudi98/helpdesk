...
<div class="container">
	...
	<div class="row">
		<div class="col-sm-8">
			...
			<!-- Client Input -->
				<form action="javascript:sendInput();" name="messageInput" id="MessageInput">
					...
					<div class="form-group" id="msgError" style="margin-top:10px;">
						<div class="input-group">
							<div class="emoji-picker">
								<div id="emoji"></div>
							</div>
							<input name="message" id="message" class="form-control modern">
							<span class="input-group-btn">
						    	<button type="button" class="btn btn-dark" id="sendMessage"><i class="fa fa-paper-plane"></i></button>
						  	</span>
						</div>
					</div>
		...
		<div class="col-sm-4 sidebar">
			...
			<!-- Close Window -->
			<p><a href="javascript:void(0)" class="btn btn-sm btn-info" id="soundoff" onclick="soundOff();"><i class="fa fa-volume-up"></i></a> <a href="<?php echo $chatdetailspop;?>" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i> <?php echo $jkl["g85"];?></a></p>

			<p><button type="submit" class="btn btn-danger btn-sm btn-confirm btn-block" data-title="<?php echo addslashes($jkl["g15"]);?>" data-text="<?php echo addslashes($jkl["g40"]);?>" data-type="warning" data-okbtn="<?php echo addslashes($jkl["g72"]);?>" data-cbtn="<?php echo addslashes($jkl["g73"]);?>"><i class="fa fa-power-off"></i> <?php echo $jkl["g15"];?></button></p>
