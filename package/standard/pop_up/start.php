		...
		<form class="jak-ajaxform" method="post" action="<?php echo htmlspecialchars($_SERVER['REQUEST_URI']);?>">
			...
			<?php } else { ?>
				...
				<div class="row text-center avatars">
					<div class="col-2">
						<label>
							<input type="radio" name="avatar" id="avatar" value="/package/standard/avatar/standard.jpg" checked>
							<img src="<?php echo BASE_URL;?>/package/standard/avatar/standard.jpg" class="rounded img-fluid" alt="avatar standard">
						</label>
					</div>
					<div class="col-2">
						<label>
	    					<input type="radio" name="avatar" value="/package/standard/avatar/4.jpg">
	    					<img src="<?php echo BASE_URL;?>/package/standard/avatar/4.jpg" class="rounded img-fluid" alt="avatar4">
	  					</label>
					</div>
					<div class="col-2">
						<label>
	    					<input type="radio" name="avatar" value="/package/standard/avatar/2.jpg">
	    					<img src="<?php echo BASE_URL;?>/package/standard/avatar/2.jpg" class="rounded img-fluid" alt="avatar2">
	  					</label>
					</div>
					<div class="col-2">
						<label>
	    					<input type="radio" name="avatar" value="/package/standard/avatar/3.jpg">
	    					<img src="<?php echo BASE_URL;?>/package/standard/avatar/3.jpg" class="rounded img-fluid" alt="avatar3">
	  					</label>
					</div>
					<div class="col-2">
						<label>
	    					<input type="radio" name="avatar" value="/package/standard/avatar/1.jpg">
	    					<img src="<?php echo BASE_URL;?>/package/standard/avatar/1.jpg" class="rounded img-fluid" alt="avatar">
	  					</label>
					</div>
					<div class="col-2">
						<label>
							<input type="radio" name="avatar" value="/package/standard/avatar/5.jpg">
							<img src="<?php echo BASE_URL;?>/package/standard/avatar/5.jpg" class="rounded img-fluid" alt="avatar5">
						</label>
					</div>
				</div>
				<?php } ?>
