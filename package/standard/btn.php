...
if ($USR_IP_BLOCKED) {
	...
	if ($online_op) {
		...
		if ($jakwidget['widget'] == 1 && !isset($_SESSION["clientismobile"])) {
			...
			$widgethtml = '<div id="lcjframesize" class="live-chat-slideup-container animated"><div id="lcj-proactive"><p></p><span class="yes" onclick="lcjak_engageOpen();return false;"></span><span class="no" onclick="lcjak_engageClose();return false;"></span></div><div id="lcj-lastmessage"><p></p></div>'.$slideimg.'<div class="lcj-chat-header'.$theme.'" style="'.$titlefont.$backgroundc.'"><a href="'.$chatstarturl.'"><span class="lcj-sprite lcj-sprite-logo"></span><div class="lcj-title">'.$jakwidget['title'].'</div></a>'.$thepoup.'</div>';

			// Set session to slide up
			$_SESSION["setchatstyle"] = 1;

		// We have a small slide up
		} elseif ($jakwidget['widget'] == 2 && !isset($_SESSION["clientismobile"])) {

			$widgethtml = '<div id="lcjframesize" class="live-chat-slideup-container animated"><div id="lcj-proactive"><p></p><span class="yes" onclick="lcjak_engageOpen();return false;"></span><span class="no" onclick="lcjak_engageClose();return false;"></span></div><div id="lcj-lastmessage"><p></p></div>'.$slideimg.'<div class="lcj-chat-header small'.$theme.'" style="'.$titlefont.$backgroundc.'"><a href="'.$chatstarturl.'"><span class="lcj-sprite lcj-sprite-logo"></span><div class="lcj-title">'.$jakwidget['title'].'</div></a>'.$thepoup.'</div>';
		...
		} elseif ($jakwidget['widget'] == 4 && !isset($_SESSION["clientismobile"])) {
	...
	// No operator is online or user is blocked
	    ...
	    // We will show the contact form
			...
			if ($jakwidget['widget'] == 1 && !isset($_SESSION["clientismobile"])) {
				...
				$widgethtml = '<div id="lcjframesize" class="live-chat-slideup-container animated"><div id="lcj-proactive"><p></p><span class="yes" onclick="lcjak_engageOpen();return false;"></span><span class="no" onclick="lcjak_engageClose();return false;"></span></div><div id="lcj-lastmessage"><p></p></div>'.$slideimg.'<div class="lcj-chat-header'.$theme.'" style="'.$titlefont.$backgroundc.'"><a href="'.$chatcontacturl.'"><span class="lcj-sprite lcj-sprite-logo"></span><div class="lcj-title">'.$jakwidget['title'].'</div></a>'.$thepoup.'</div>';
