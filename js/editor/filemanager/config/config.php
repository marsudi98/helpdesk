...
if (JAK_USERID) {
	$_SESSION['RF']["verify"] = "JAKFilemanagerAccess";
} else {
	unset($_SESSION['RF']["verify"]);
}
...
$config = array(
	...
	*/
	...
	|
	*/
	'thumbs_base_path' => '../../..'.JAK_EDITOR_PATH_THUMBS,
